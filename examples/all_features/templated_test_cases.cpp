...
TEST_CASE_TEMPLATE_INVOKE(test_id, double,
                          double); // note that types won't be filtered for uniqueness
...
TEST_CASE_TEMPLATE("multiple types", T, TypePair<int, char>, TypePair<char, int>,
                   TypePair<bool, int>) {
